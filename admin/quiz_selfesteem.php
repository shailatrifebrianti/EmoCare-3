<?php
$pageTitle = 'Buat Kuis • Self-Esteem';
...
?>
<div class="ec-card">
  <div class="ec-title">Buat Kuis (Self-Esteem)</div>
  <?php if ($flash): ?><p class="note"><?= htmlspecialchars($flash) ?></p><?php endif; ?>
  <form method="post" enctype="multipart/form-data">
    <input type="hidden" name="csrf" value="<?= htmlspecialchars($_SESSION['csrf']) ?>">
    <label class="label">Pertanyaan</label>
    <textarea class="textarea" name="question" rows="3" placeholder="Contoh: Saya sering meremehkan kemampuan diri sendiri."></textarea>

    <div class="row" style="margin-top:10px">
      <div>
        <label class="label">Opsi 1</label>
        <input class="input" name="opt1" placeholder="Tidak Pernah">
      </div>
      <div>
        <label class="label">Opsi 2</label>
        <input class="input" name="opt2" placeholder="Jarang">
      </div>
      <div>
        <label class="label">Opsi 3</label>
        <input class="input" name="opt3" placeholder="Sering">
      </div>
      <div>
        <label class="label">Opsi 4</label>
        <input class="input" name="opt4" placeholder="Sangat Sering">
      </div>
    </div>
